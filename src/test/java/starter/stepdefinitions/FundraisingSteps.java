...
public class FundraisingSteps {
    ...
    public void receiveResponse(){
        manageFundraising.statusCodeReqFundManag(200);
    }
    ...
    public void responsecodeNoDesc(){
        manageFundraising.statusnoDescReqFundManag(500);
    }
    ...
    public void sendReqPATCH(){manageFundraising.sendReqPatchFund();}
    @Then ("I receive PATCH HTTP response code 200")
    public void statuscodePATCHFund(){manageFundraising.statuscodePATCHFund();}
